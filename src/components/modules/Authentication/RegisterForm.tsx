...
const registerSchema = z
  .object({
    ...
    role: z.enum(["USER", "AGENT"], { message: "Select a role" }),
  })
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <select {...field} className="w-full border rounded p-2 ">
                      <option value="USER" className="bg-white-600">User</option>
                      <option value="AGENT" className="bg-white-600">Agent</option>
                    </select>
                  </FormControl>
                  <FormMessage />
                </FormItem>
